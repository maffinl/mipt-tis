...
def country(country_id=None):
    ...
    ret = render_template("country.html",country_info=country_info[0], language_info=language_inf>    return ret
...
def person(person_id=None):
    ...
    ret = render_template("persons.html", countries_info=countries_info, events_info=events_info,>    return ret
...
def event(event_id=None):
    ...
    ret = render_template("events.html", countries_info=countries_info, event_info=event_info[0],>    return ret
